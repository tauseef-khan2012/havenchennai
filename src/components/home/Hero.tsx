    ...
    <div className="relative h-[90vh] bg-black overflow-hidden">
      ...
      <div className="relative h-full container-custom flex flex-col justify-center">
        <div className="max-w-2xl animate-fade-up">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Escape to Nature at Haven</h1>
          <p className="text-xl text-white mb-8">Experience our unique container home stay surrounded by pristine wilderness and curated outdoor adventures.</p>
