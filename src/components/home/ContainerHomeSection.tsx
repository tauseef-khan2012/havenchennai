...
const ContainerHomeSection = () => {
  ...
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-br from-haven-beige via-white to-haven-beige/30 relative overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
              <img 
                ...
                alt="Haven Container Home Exterior - Multi-level decks overlooking Muttukadu Lake"
