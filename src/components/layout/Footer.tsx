...
const Footer = () => {
  ...
  return (
    <footer className="bg-haven-dark text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              {/* Social Icons */}
              <a href="#" className="text-white hover:text-haven-light-blue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/stay" className="text-gray-300 hover:text-white transition-colors">Our Container Home</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/blog" className="text-gray-300 hover:text-white transition-colors">Haven Journal</Link></li>
